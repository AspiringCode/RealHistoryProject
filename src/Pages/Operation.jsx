      ...
      <div className="grid lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section className="glass-card-dark-strong rounded-2xl p-8 shadow-xl">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-slate-300 leading-relaxed mb-4">
                In Washington, the guns fell silent only to ignite a firestorm of political and public debate. The domestic fallout of Operation Midnight Hammer was immediate and intense, another instance that a “successful” military strike can carry aftershocks well into the future. One of those shocks was the Strait of Hormuz and global oil. Within hours of the bombing, Iran threatened to retaliate by closing the Strait – a chokehold through which about 20% of the world’s daily oil, or about 18 million barrels, flows (Energy Information Administration). Although Iran did not act immediately, the fear of doing so sent global oil markets into panic. Crude oil prices spiked overnight – Brent crude jumped by nearly $10 in a single day (Thrush and Rappeport), stoking worries of gas price inflation at home. When one woke up that day, they woke up to the news of $5–$6 per gallon of gasoline if the crisis worsened.
              </p>
              <p className="text-slate-300 leading-relaxed mb-4">
                The U.S. government scrambled to mitigate as much of the international fallout as possible – they put the Strategic Petroleum Reserve on standby and dispatched envoys to other OPEC countries urging them to saturate the oil market (release more barrels) to calm the markets (Energy Information Administration; International Energy Agency, Iran Crisis and Oil Market Report). Economists warned that if Iran even partially choked Hormuz’s oil flow, the ensuing supply shock could start a global recession (International Energy Agency, Iran Crisis and Oil Market Report). The idea of this possibility placed enormous pressure on the administration to keep the Strait open. U.S. naval fleets in the Gulf were placed on high alert so as to escort tankers, and coalition talks were initiated to form a maritime protection mission (Zengerle).
              </p>
              <p className="text-slate-300 leading-relaxed mb-4">
                Because President Trump had launched the strikes without seeking Congressional authorization, many in Congress, Democrats and Republicans alike, were furious at the bypass of their war powers. Within days, the Senate Majority Leader and Speaker of the House convened hearings. A bipartisan group of lawmakers then introduced a War Powers Resolution to explicitly require the President to obtain approval before any military action against Iran was taken (Zengerle). Proponents of the act argued that however one felt about Iran, the precedent of a president unilaterally starting hostilities of this magnitude was dangerous. “We cannot let one person decide to plunge the nation into war,” one senator urged, commenting that even if this strike was over, Iran’s likely retaliation could drag the U.S. into a wider conflict (U.S. Senate, War Powers and Iran). Opponents of the resolution, however, countered that the President had acted lawfully as Commander-in-Chief in a limited strike, not a full war – and that tying his hands now would only embolden Iran. After a tense vote, the war powers resolution narrowly failed in the Senate (a 53–47 vote against) (Zengerle).
              </p>
              <p className="text-slate-300 leading-relaxed">
                Public opinion was also sharply divided. In a poll, a small majority of Americans supported the operation, whereas a large minority of people criticized the President. Of this minority, protests broke out in cities, with demonstrators chanting “No War with Iran” (Jones). Uneasiness had spread like wildfire through the entirety of the states. <Hint mediumHint="There are two hidden digits in the previous section" hardHint="Two digits can be found in the upper half of this page" showInEasy={false} showInMedium={true} showInHard={true} />
              </p>
            </div>
          </section>
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-slate-900/40 rounded-xl p-6 border border-white/10 flex flex-col">
                ...
                <div className="flex-1 flex items-end gap-2 h-40 px-2 pb-2 border-b border-l border-slate-600 relative">
                  {/* Graph Bars/Line */}
                  <div className="w-1/5 h-[40%] bg-slate-600/50 rounded-t mx-auto relative group">
                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity">$75</div>
                  </div>
                  <div className="w-1/5 h-[42%] bg-slate-600/50 rounded-t mx-auto relative group">
                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity">$78</div>
                  </div>
                  <div className="w-1/5 h-[38%] bg-slate-600/50 rounded-t mx-auto relative group">
                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity">$72</div>
                  </div>
                  {/* The Spike */}
                  <div className="w-1/5 h-[85%] bg-red-500 shadow-[0_0_15px_rgba(239,68,68,0.5)] rounded-t mx-auto relative group animate-pulse">
                    <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-sm font-bold text-red-400">$115</div>
                  </div>
                  <div className="w-1/5 h-[75%] bg-red-500/60 rounded-t mx-auto relative group">
                    <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity">$108</div>
                  </div>
                </div>

                <div className="flex justify-between text-xs text-slate-500 mt-2 px-2">
                  <span>Pre-Strike</span>
                  <span className="text-red-400 font-semibold">Strike Day</span>
                  <span>Post-Strike</span>
                </div>
                <p className="text-xs text-right text-slate-600 mt-3">Source: Simulated Market Data based on EIA Projections</p>
              </div>
            </div>
          </section>
