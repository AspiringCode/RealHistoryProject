      ...
      <div className="space-y-12">
        ...
        <section className="glass-card-dark-strong rounded-2xl p-8 shadow-xl relative">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-slate-300 leading-relaxed">
              It also made U.S. involvement de facto necessary if the goal was to truly cripple Iran's nuclear potential. Israeli officials essentially admitted this; they lobbied Washington for access to MOPs or U.S. strike support for years (Broad and Sanger). In war-game scenarios, Israel could perhaps seal the entrances to Fordow or cause damage by repeated strikes, but outright destruction required the bunker-busters and heavy bombers only the Americans possessed (Albright et al.). By mid-June 2025, after Israel's initial raids, Fordow loomed as the unfinished business. Iran, fully aware of Fordow's value, moved additional stockpiles and advanced centrifuges into the site, hunkering down ("Nuclear Program of Iran"). For the U.S. and Israel, Fordow was the ultimate challenge: a nuclear site literally built to survive their onslaught. The success of Operation Midnight Hammer – and the hope of setting back Iran's bomb program for years – hinged on whether this underground bastion could be cracked open. <Hint easyHint="Check the bottom of this section for a hidden digit" showInEasy={true} showInMedium={false} showInHard={false} />
            </p>
          </div>
        </section>
