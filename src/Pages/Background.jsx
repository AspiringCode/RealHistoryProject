      ...
      <div className="grid lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section className="glass-card-dark-strong rounded-2xl p-8 shadow-xl border border-white/10 relative">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-slate-300 leading-relaxed mb-4">
                During the Cold War, Iran’s nuclear journey began not as rogue, but as part of America’s Atoms for Peace program (Rowberry). In 1957, under Iran’s pro-Western Shah, Washington and Tehran signed a nuclear cooperation agreement that enabled a jump-start to Iran’s civilian nuclear capacity (Rowberry). The U.S. provided Iran with a small 5 MW Research Reactor in 1967—along with weapons-grade fuel for it—and trained Iranian scientists in the art of nuclear engineering (Rowberry; Arms Control Association, “Iran’s Nuclear Program: Background and History”). Throughout the 1970s, the Shah’s government expanded the program, establishing the basis of Iran’s nuclear infrastructure (Rowberry).
              </p>
              <p className="text-slate-300 leading-relaxed mb-4">
                Even after the 1979 Iranian Revolution (which cut ties with the U.S.), those American-built facilities and Western-trained experts remained. The new republic inherited a running reactor and a plethora of qualified nuclear personnel—a foundation it would use to pursue its own goals (Rowberry). In the 1980s, Iran tapped other sources like Pakistan, China, and Russia to keep its nuclear interests alive (Arms Control Association, "Iran's Nuclear Program: Background and History"). But the very roots of the program were traced back to the initial era of U.S.-backed "Atoms for Peace." What had begun as cooperation toward peaceful development of nuclear energy, by the end of the millennium, had already laid the groundwork for tensions and control. How far could Iran push this program, and to what end? <Hint easyHint="Look for a hidden digit at the top of this section" mediumHint="" hardHint="" showInEasy={true} showInMedium={false} showInHard={false} />
              </p>
            </div>
          </section>
          ...
          <section className="glass-card-dark-strong rounded-2xl p-8 shadow-xl border border-white/10">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-slate-300 leading-relaxed mb-4">
                Fast-forwarding to the early 2000s, what had been a relatively cooperative program had become shrouded in secrecy, which caught global attention. In 2002, an exiled opposition group revealed the existence of undeclared nuclear sites—most notably a massive underground enrichment facility at Natanz and a heavy-water reactor project at Arak (Arms Control Association, “Timeline of Nuclear Diplomacy with Iran”; “Nuclear Program of Iran”). The revelations jolted the international community. Iran, a signer of the Non-Proliferation Treaty, was obligated to declare facilities of that nature to the International Atomic Energy Agency (IAEA), but it had not (Heinonen). Over the next few years, UN nuclear inspectors investigated these sites and consequently uncovered a pattern of suspicious activities—such as uranium enrichment experiments and plutonium-related research—that Iran had failed to report yet again (Heinonen; IAEA, Implementation of the NPT Safeguards Agreement in Iran). The IAEA’s findings of Iran’s non-compliance led to a series of UN Security Council resolutions between 2006 and 2010 that imposed sanctions on Iran and demanded it suspend enrichment entirely (Heinonen; United Nations Security Council). The world had effectively placed Iran’s nuclear program in a vise.
              </p>
              <p className="text-slate-300 leading-relaxed">
                By 2015, all that bargaining and pressure produced a landmark deal: the Joint Comprehensive Plan of Action (JCPOA). Backed by the UN in Resolution 2231, the JCPOA put Iran’s nuclear program under strict limits (United Nations Security Council Resolution 2231). Under this, Iran could enrich uranium only to 3.67% purity (far below weapons-grade) and could stockpile only 300 kg of that low-enriched uranium (“Nuclear Program of Iran”). It had to remove and store most of its centrifuges, leaving just over 5,000 basic models operational, and halt enrichment entirely at the hardened Fordow site (“Nuclear Program of Iran”; Davenport). The deal also required that the heavy-water reactor at Arak be redesigned so it could not produce bomb-grade plutonium (“Nuclear Program of Iran”; IAEA, Verification and Monitoring in Iran). Most importantly, it introduced an unprecedented verification regime: the IAEA gained round-the-clock access to key facilities, remote cameras, and the authority to inspect suspect sites—ensuring any significant cheating would be detected (IAEA, Verification and Monitoring in Iran). For a time, this arrangement acted like fragile scaffolding around Iran’s nuclear ambitions: the program persisted, but it was boxed in and closely monitored. Many experts hailed the JCPOA as a triumph of nonproliferation diplomacy, albeit a temporary one (Davenport). It bought the world nearly a decade of confidence that Iran could not race for a bomb undetected. However, it remained inherently fragile: if any party in power withdrew, or if Iran violated its commitments after the deal’s expiry, all of the peace and confidence garnered could collapse and old fears would inevitably return. <Hint easyHint="" mediumHint="There's a hidden digit in the previous section" hardHint="" showInEasy={false} showInMedium={true} showInHard={false} />
              </p>
            </div>
